  ...
  return (
    ...
    <div>
      <Head>
        ...
        <meta name="description" content="Prepare your next interview with AI-powered mock interviews" />
      ...
      <main className="min-h-screen">
        ...
        {/* Hero Section */}
        <section className="flex flex-col items-center justify-center text-center py-20 bg-gradient-to-r from-[#1E5B53] to-[#291850]  px-6 md:px-0">
          <h2 className="text-4xl md:text-5xl font-bold text-white">Prepare Your Next Interview</h2>
          ...
          <div className="mt-6 flex flex-col md:flex-row">
            ...
            <a
              href="#features"
              className="px-6 py-3 text-lg font-semibold border border-white rounded-lg bg-white bg-opacity-30 hover:bg-white hover:text-black-600"
            >
              Learn More
            </a>
          </div>
            ...
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Azahar masoud</h4>
                </div>
              </div>
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Sayem Murshed Sajeeb</h4>
                </div>
              </div>
            </div>
          </div>
